...
const Banner = () => {
  ...
  return (
    <div className="relative w-full bg-accent overflow-hidden lg:pt-20 pt-10">
      <div
      ...
      <button
        className="absolute top-1/2 left-2 lg:left-0 transform -translate-y-1/2 bg-transparent text-secondary border-2 rounded-full border-secondary px-3 lg:px-4 py-3 lg:py-4 ml-2 lg:ml-6 hover:bg-secondary hover:text-neutral"
        onClick={prevSlide}
      >
        <FaArrowLeft />
      </button>
      <button
        className="absolute top-1/2 right-2 lg:right-0 transform -translate-y-1/2 bg-transparent text-secondary border-2 rounded-full border-secondary px-3 lg:px-4 py-3 lg:py-4 mr-2 lg:mr-6 hover:bg-secondary hover:text-neutral"
        onClick={nextSlide}
      >
        <FaArrowRight />
      </button>
